...
#'
#' @description
#' IRLS regression approach with optional point weights. In this package, the weights
#' could be precipitation or streamflow volume for calculating the weighted or
#' unweighted young water fraction (Fyw).
#'
...
#' mass-weighted regressions) the default weight vector gives all pweights the
#' value of 1.
#' @param iweights An optional numeric vector of initial values for the residual
#' weights for the IRLS, the default weight vector gives all initial iweights's
#' the value of 1.
#' @param type An optional string constant indicating the weight function.
#' the value of type could be "bisquare", "Welsch", or "Cauchy". Default weight
#' function is Cauchy.
#'
#' @importFrom stats lm
#' @importFrom stats median
#'
#' @return Object of class "lm", generated by a call with the initial weighted
#' updated by the selected weighting function fit$iweights
#'
#' @source The IRLS used in this function was copied and modified from the code
#' provided in this link \url{https://doi.org/10.5194/hess-22-3841-2018-supplement}.
#
#' @references
...
#' properties across 22 Swiss catchments. \emph{Hydrol. Earth Syst. Sci.}, 22,
#' 3841–3861. \url{https://doi.org/10.5194/hess-22-3841-2018-supplement}.
#'
#'
#' @examples
